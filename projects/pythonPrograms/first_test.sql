...
QUERY = '''
select ordernames.name, count(*) as num from ordernames join taxonomy join animals
on taxonomy.t_order = ordernames.t_order and animals.species = taxonomy.name
